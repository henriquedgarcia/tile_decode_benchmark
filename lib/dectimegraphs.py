...
class DectimeGraphsOptions(Enum):
    BY_PATTERN = 0
    BY_PATTERN_FULL = 1
    BY_PATTERN_QUALITY = 2
    BY_VIDEO_PATTERN_QUALITY = 3
    BY_VIDEO_PATTERN_TILE_CHUNK = 4
    BY_VIDEO_PATTERN_TILE_QUALITY_CHUNK = 5
...
class DectimeGraphs(Base):
    operations = {'BY_PATTERN': ByPattern,
                  'BY_PATTERN_FULL': ByPattern,
                  'BY_PATTERN_QUALITY': ByPattern,
                  'BY_VIDEO_PATTERN_QUALITY': ByPattern,
                  'BY_VIDEO_PATTERN_TILE_CHUNK': ByPattern,
                  'BY_VIDEO_PATTERN_TILE_QUALITY_CHUNK': ByPattern,
                  }
